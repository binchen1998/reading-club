...
SQUARE_STATS = f"{PREFIX}:square:stats"
SQUARE_LIST = f"{PREFIX}:square:list:{{sort}}:p{{page}}:s{{page_size}}"
SQUARE_LIST_INDEX = f"{PREFIX}:idx:square_list"
SQUARE_DETAIL = f"{PREFIX}:square:detail:{{recording_id}}"
SQUARE_DETAIL_INDEX = f"{PREFIX}:idx:square_detail"
LEADERBOARD_RISE = f"{PREFIX}:leaderboard:rise"
LEADERBOARD_TALENT = f"{PREFIX}:leaderboard:talent"
LEADERBOARD_HONOR = f"{PREFIX}:leaderboard:honor"
LEADERBOARD_UPDATED = f"{PREFIX}:leaderboard:updated_at"
